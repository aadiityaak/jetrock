    ...
    >
        ...
        <div class="flex justify-between mb-10 pr-3 sm:px-2">
            ...
            <a class="block" href="{{ route('dashboard') }}">
                <img src="{{ asset('images/icon-vd.png') }}" alt="logo" class="w-10 h-10">
            </a>
        </div>
                            ...
                            <ul class="pl-9 mt-1" :class="{ 'hidden': !open }" x-cloak>
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate @if(Route::is('users.index')){{ '!text-indigo-500' }}@endif" href="{{ route('users.index') }}">
                                        <span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">List Akun</span>
                                    </a>
                                </li>
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate @if(Route::is('users.role')){{ '!text-indigo-500' }}@endif" href="{{ route('users.role') }}">
                                ...
                                <li class="mb-1 last:mb-0">
                                    <form method="POST" action="{{ route('logout') }}" x-data>
                                        ...
                                        <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate" href="{{ route('logout') }}" @click.prevent="$root.submit();">
                                            <span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Log Out</span>
                                        </a>
                                    </form>                                     
                                </li>
                            </ul>
